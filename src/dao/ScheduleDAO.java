...
public class ScheduleDAO {
    ...
    // Method to get schedules by movie ID and theater ID
    public List<Schedule> getSchedulesByMovieIdAndTheaterId(int movieId, int theaterId) {
        List<Schedule> schedules = new ArrayList<>();
        String sql = "SELECT * FROM schedules WHERE movie_id = ? AND theater_id = ?";
